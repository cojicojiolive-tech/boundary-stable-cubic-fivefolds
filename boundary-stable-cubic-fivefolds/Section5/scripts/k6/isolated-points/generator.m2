-- ==============================================================
--  isolated_k6_to_singular_v6.m2      (Macaulay2 ≥ 1.25)
--  * Extract projective isolated singular points (codim = 6 only) for k = 6 (φ_nf_6)
...
---------------------------------------------------------------
-- 0.  Ring and polynomial (k=6 normal form)
---------------------------------------------------------------
...
print "*** Projective singular locus for k=6 (φ_nf_6) ***";
print "------------------------------------------------------------";
...
--     In the present k=6 case, one expects a single point [1:0:...:0]
---------------------------------------------------------------
coordsString = vChart -> (
